...
function Home() {
    return (
        <>
            ...
            <Header />
            <div className="w-screen  bg-orange-600 py-5">
                <div className="container w-auto flex justify-between  min-[850]:h-20  lg:gap-3 gap-4   items-center lg:flex-row flex-col">
                    ...
                    <div className="flex justify-center items-center gap-5">
                        ...
                        <p className="text-lg md:text-2xl  font-extrabold text-[#1f1f1f]" >01169266014</p>
                    </div>
                    <div className="flex justify-center items-center gap-5">
                        <div className="w-10 h-10 md:w-12 md:h-12 bg-white rounded-full flex justify-center items-center">
                            <RiInstagramFill className="text-[#1f1f1f]  text-lg md:text-xl" />
                        </div>
                        <p className="text-lg md:text-2xl font-extrabold text-[#1f1f1f]" >@babagcabs</p>
                    </div>
                    <div className="flex justify-center items-center gap-5">
                        <div className="w-10 h-10 md:w-12 md:h-12 bg-white rounded-full flex justify-center items-center">
                            <FaLocationDot className="text-[#1f1f1f  text-lg md:text-xl]" />
                        </div>
                        <p className="text-lg md:text-2xl font-extrabold text-[#1f1f1f]" >Sector-6, Gurgaon Haryana 122006</p>
                    </div>
                </div>
            </div>
            <About />
