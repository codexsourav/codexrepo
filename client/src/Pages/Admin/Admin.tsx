    ...
    return (
        <>
            ...
            <div className="z-50 fixed bottom-0 sm:bottom-10 left-1/2 transform -translate-x-1/2 bg-slate-200 opacity-100  p-4 w-screen sm:w-96 h-16 rounded flex justify-between items-center px-8">
                <MenuItem item={<GoHomeFill size={30} color={tabIndex == 0 ? "#ea580c" : ""} />} hint="Home" onClick={() => setTabIndex(0)} />
                <MenuItem item={<FaUsers size={30} color={tabIndex == 1 ? "#ea580c" : ""} />} hint="Users" onClick={() => setTabIndex(1)} />
                <MenuItem item={<BsStack size={30} color={tabIndex == 2 ? "#ea580c" : ""} />} hint="Booking" onClick={() => setTabIndex(2)} />
                <MenuItem item={<FaCarAlt size={30} color={tabIndex == 3 ? "#ea580c" : ""} />} hint="Manage Cabs" onClick={() => setTabIndex(3)} />
            </div>
