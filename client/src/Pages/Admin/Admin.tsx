...
function Admin() {
    ...
    return (
        <>
            ...
            <div className="fixed bottom-0 sm:bottom-10 left-1/2 transform -translate-x-1/2 bg-gray-300 opacity-55  p-4 w-screen sm:w-96 h-16 rounded flex justify-between items-center px-8">
